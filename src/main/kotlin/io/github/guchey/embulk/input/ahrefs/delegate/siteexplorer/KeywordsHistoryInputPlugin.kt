...
class KeywordsHistoryInputPlugin<T : KeywordsHistoryInputPlugin.PluginTask> : AhrefsBaseDelegate<T>() {
    ...
    override fun buildRequest(task: T): Request {
        ...
        return Request.Builder()
            .url(buildUrl("${task.getAhrefsUrl()}/v3/site-explorer/keywords-history", queryParam))
    ...
    override fun buildServiceResponseMapper(task: T): ServiceResponseMapper<out ValueLocator> {
        ...
        builder
            ...
            .add("top3", Types.LONG)
            .add("top4_10", Types.LONG)
            .add("top11_plus", Types.LONG)
